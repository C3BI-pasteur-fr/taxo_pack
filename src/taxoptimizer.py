    ...
    if args.bdbfile:
        ...
        if args.bdbtype == 'ncbi':
            try:
                ...
                print >>sys.stderr, TaxOptimizerError("NCBI TaxoDB database is mandatory in bekley db format") 
                sys.exit(1)
            ...
            try:
                ...
                print >>sys.stderr, TaxOptimizerError("Greengenes TaxoDB database is mandatory in bekley db format")
                sys.exit(1)
            ...
            try:
                ...
                print >>sys.stderr, TaxOptimizerError("Silva TaxoDB database is mandatory in bekley db format")
                sys.exit(1)
